...
- `CLAUDE.md` dosyasındaki `Benim Annem Bir Melek: Aile ve Aşk Hikayesi`, `Benim Annem Bir Melek: Aile ve Aşk Hikayesi — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
